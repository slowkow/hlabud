...
Here are a few examples that demonstrate how to use hlabud in an analysis.
...
```{r, fig.width = 6, fig.height = 4, fig.dpi = 300, echo = FALSE}
...
```{r, cache=TRUE, echo = FALSE, fig.dpi = 300, fig.width = 9, fig.height = 6, message=FALSE, warning=FALSE}
