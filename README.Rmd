...
hlabud provides methods for retrieving sequence alignment data from the [IMGTHLA] database, and for converting the sequence alignments into R matrices ready for downstream analysis. The [vignette](vignettes/examples.md) shows examples of how to use the data with logistic regression and dimensionality reduction.
